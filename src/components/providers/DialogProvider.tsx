    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 px-4">
      <div className="w-full max-w-md rounded-2xl bg-card border border-border shadow-xl p-6">
        ...
        <div className="flex justify-end gap-3">
          <button
            onClick={handleClose}
            className="px-4 py-2 cursor-pointer text-sm font-semibold rounded-lg border border-border hover:border-primary transition"
          >
            {dialogState.cancelText}
          </button>
          <button
            onClick={handleConfirm}
            className="px-4 py-2 text-sm cursor-pointer font-semibold rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition"
          >
